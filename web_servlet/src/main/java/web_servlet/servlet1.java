...
/*
해당 class는 웹에서 가상으로 제공되는 자바 입니다. 즉, extends HttpServlet
servlet이라는 class를 상속 받아서 웹이 작동 되도록 하는 웹 전용 클래스 입니다.
...
public class servlet1 extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		response.setContentType("text/html");	//jsp에 전달될 데이터를 문자 또는 html 코드로 전달 할 수 있는 기능
		...
		rd.forward(request, response);	//.do가 실행 되었을 때 .jsp 파일을 로드 하여 같이 출력
